...
{
	/// <summary>
	/// <para>Helper class that simplifies definition of NUnit exception expectations.</para>
	/// <para>Usage:</para>
	/// <code>[Expects.ArgumentNullException]</code>
	/// </summary>
...
#pragma warning disable 1591
		...
		public sealed class TimeoutException : ExpectedExceptionAttribute
		{
			public TimeoutException()
				: base(typeof (System.TimeoutException))
			{
			}
		}
		...
		public sealed class ArgumentException : ExpectedExceptionAttribute
		{
			public ArgumentException()
				: base(typeof (System.ArgumentException))
			{
			}
		}
